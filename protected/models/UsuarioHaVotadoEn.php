...
/**
 * This is the model class for table "usuario_ha_votado_en".
 *
 * The followings are the available columns in table 'usuario_ha_votado_en':
 * @property integer $id
...
class UsuarioHaVotadoEn extends CActiveRecord
{
	 ...
	 * @return UsuarioHaVotadoEn the static model class
	 */
