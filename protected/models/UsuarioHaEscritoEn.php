...
/**
 * This is the model class for table "usuario_ha_escrito_en".
 *
 * The followings are the available columns in table 'usuario_ha_escrito_en':
 * @property integer $id
...
class UsuarioHaEscritoEn extends CActiveRecord
{
	 ...
	 * @return UsuarioHaEscritoEn the static model class
	 */
